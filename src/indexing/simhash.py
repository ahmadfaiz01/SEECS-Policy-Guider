...
<<<<<<< HEAD
        ...
        """
        # Query expansion: repeat content tokens to amplify their signal.
        # This reduces the length mismatch between a short query and 150-word chunks.
        tokens = [t for t in text.lower().split() if len(t) > 2 and not t.isdigit()]
        if len(tokens) < 30:
